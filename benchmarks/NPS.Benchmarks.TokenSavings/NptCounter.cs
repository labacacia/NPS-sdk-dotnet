...
/// <summary>
/// NPT (NPS Token) counter per <c>spec/token-budget.md §2.2</c>. When the tokenizer
/// cannot be determined, NPT = <c>ceil(UTF-8 bytes / 4)</c>. We use that fallback
...
/// </summary>
public static class NptCounter
{
    /// <summary>Count NPT for a single UTF-8 encoded message.</summary>
    ...
    /// <summary>Count NPT for a sequence of messages (request + response per call, etc.).</summary>
